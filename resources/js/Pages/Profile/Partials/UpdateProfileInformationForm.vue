...
const form = useForm({
    ...
    photo: null,
    gender_id: props.user.gender_id ? props.user.gender_id: '',
    birth_year: props.user.birth_year ? props.user.birth_year: '',
    birth_month: props.user.birth_month ? props.user.birth_month: '',
    birth_day: props.user.birth_day ? props.user.birth_day : '',
    debut_year: props.user.debut_year ? props.user.debut_year: '',
    debut_month: props.user.debut_month ? props.user.debut_month: '',
