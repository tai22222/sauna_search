...
// 施設タイプ
const facilityTypesArray = Array.isArray(facilityTypes)
  ? facilityTypes
  : [facilityTypes];
...
const imageUrls = ref([
  ...
  { key: "image1_url", value: props.imagesFacilities[0].image1_url },
  { key: "image2_url", value: props.imagesFacilities[0].image2_url },
  { key: "image3_url", value: props.imagesFacilities[0].image3_url },
  { key: "image4_url", value: props.imagesFacilities[0].image4_url },
  { key: "image5_url", value: props.imagesFacilities[0].image5_url },
]);
...
const updateSaunaInformation = () => {
  ...
  Object.entries(form).forEach(([key, value]) => {
    if (
      value !== null &&
      !(key.includes("_url") && value instanceof File) &&
  ...
  axios
    .put(`/sauna_search/public/api/sauna/${props.sauna.id}`, formData, {
      headers: {
  ...
  axios
    .post(`/sauna_search/public/api/sauna/${props.sauna.id}`, newFormData)
    .then((response) => {
      console.log("レスポンスデータ");
      console.log(response.data);
    })
    ...
    <div>
      <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div v-if="$page.props.jetstream.canUpdateProfileInformation">
          <div
            class="mb-16 px-4 py-5 sm:px-20 sm:py-10 bg-sub shadow rounded-lg text-white"
          >
            <h2 class="text-2xl font-bold text-white text-center mb-10">
              施設を修正
            </h2>
            <p>
              会員登録されている方であれば、誰でも施設情報を登録・更新することができます。
            </p>
            <p>
              皆様のサウナライフをより良いものにしていただくために、より正確な情報をご提供いただけると幸いです。
            </p>
            <p>
              すでに施設情報が登録されており、重複登録となってしまった場合は運営側で削除させていただくこともございますので、
            </p>
            <p>
              登録前に一度施設名で検索していただき、登録がないことを確認していただけると幸いです。
            </p>
          </div>
          ...
          <FormSection @submitted="updateSaunaInformation">
            ...
            <template #form>
                ...
                <div class="md:grid md:grid-cols-6 md:gap-6 ml-8">
                  ...
                  >
                    <div>
                      ...
                      />
                      <label class="inline-block text-center text-l"
                        >定休日</label
                      >
                    </div>
                    ...
                    <div v-if="!form['is_closed_' + alfDay]">
                      <div class="grid grid-cols-6 md:gap-6">
                        ...
                        <span
                          class="flex justify-center pt-4 items-center h-full"
                          >〜</span
                        >
                        <div class="col-span-2">
                          <!-- 終了時間の入力フィールド -->
                          <InputLabel
                            for="'closing_time_' + alfDay"
                            value="営業終了時間"
                          />
                          <TextInput
              ...
              <div class="col-span-6">
                ...
                />
                <InputError
                  :message="form.errors.business_hours_detail"
                  class="mt-2"
                />
              </div>
              ...
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="relative">
                  ...
                  />
                  <span
                    class="absolute inset-y-0 right-4 pr-3 flex items-center"
                    >円</span
                  >
                </div>
              ...
              <div class="col-span-6">
                ...
                <div class="mt-1">
                  <label
                    v-for="(option, index) in stoveTypeName"
                    :key="index"
              ...
              <div class="col-span-6">
                ...
                <div class="mt-1">
                  <label
                    v-for="(option, index) in heatTypeName"
                    :key="index"
                    class="inline-flex items-center ml-2"
                  >
                    <input
              ...
              <div class="col-span-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-3 md:col-span-2">
                    ...
                    <InputError
                      :message="form.errors.temperature_sauna"
                      class="mt-2"
                    />
                  </div>
                </div>
              ...
              <div class="col-span-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-3 md:col-span-2">
                    ...
                    <InputError
                      :message="form.errors.capacity_sauna"
                      class="mt-2"
                    />
                  </div>
                </div>
              ...
              <div class="col-span-6">
                ...
                />
                <InputError
                  :message="form.errors.additional_info_sauna"
                  class="mt-2"
                />
              </div>
              ...
              <div class="col-span-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-3 md:col-span-2">
                    ...
                    <InputError
                      :message="form.errors.temperature_water"
                      class="mt-2"
                    />
                  </div>
                </div>
              ...
              <div class="col-span-6">
                <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-3 md:col-span-2">
                    ...
                    <InputError
                      :message="form.errors.capacity_water"
                      class="mt-2"
                    />
                  </div>
                </div>
              ...
              <div class="col-span-6">
                ...
                />
                <InputError
                  :message="form.errors.access_text_water"
                  class="mt-2"
                />
              </div>
              ...
              <div class="col-span-6">
                ...
                <div class="grid grid-cols-6 gap-8">
                  <div
                    ...
                    :key="index"
                    class="col-span-6 md:col-span-2 sm:col-span-3"
                  >
                    <input
                    ...
                    <div
                      v-if="image.value"
                      class="mt-2"
                      @click.prevent="selectNewPhoto(index)"
                    >
                      <template v-if="image.value.startsWith('data:')">
                        <!-- 画像を選択して追加した場合の処理 -->
                        <span
                      ...
                      <template v-else>
                        ...
                        <span
                          class="block rounded w-full bg-cover bg-no-repeat bg-center"
                          :style="{
                            backgroundImage: `url(${baseUrl}storage/${image.value})`,
                            paddingBottom: '100%',
                          }"
                        ></span>
                      </template>
