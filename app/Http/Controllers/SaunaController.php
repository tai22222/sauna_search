...
class SaunaController extends Controller
{
  ...
  public function store(SaunaRequest $request){
    ...
    $saunaData = $request->only([
        'facility_name', 'facility_type_id', 'usage_type_id', 'prefecture_id',
    ...
    // カラム名を変更
    $saunaInfoData['temperature'] = $saunaInfoData['temperature_sauna'];
    $saunaInfoData['capacity'] = $saunaInfoData['capacity_sauna'];
    unset($saunaInfoData['temperature_sauna']);
    unset($saunaInfoData['capacity_sauna']);

    $waterBathData['temperature'] = $waterBathData['temperature_water'];
    $waterBathData['capacity'] = $waterBathData['capacity_water'];
    unset($waterBathData['temperature_water']);
    unset($waterBathData['capacity_water']);
